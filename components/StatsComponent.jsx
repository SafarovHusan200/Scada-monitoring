...
const StatsComponent = () => {
  ...
  return (
    <div className="flex gap-6 flex-wrap justify-between">
      <div className="max-w-55.5 p-6 flex justify-between gap-1 w-full rounded-lg border-l-4 border-l-[#004AC6] bg-white shadow-sm">
        <div>
      ...
      <div className="max-w-55.5 p-6 flex justify-between gap-1 w-full rounded-lg border-l-4 border-l-[#006229] bg-white shadow-sm">
        <div>
          <p className="text-[#434655] text-xs font-bold leading-4 tracking-[0.6px] uppercase mb-1">
            Normal
          </p>
      ...
      <div className="max-w-55.5 p-6 flex justify-between gap-1 w-full rounded-lg border-l-4 border-l-[#F97316] bg-white shadow-sm">
        <div>
          <p className="text-[#434655] text-xs font-bold leading-4 tracking-[0.6px] uppercase mb-1">
            Ogohlantirish
          </p>
        ...
        <div className="w-11.5 h-11.5 flex justify-center p-3 rounded-lg bg-[#F97316]/10">
          <img src="/icons/warning.svg" />
        </div>
      </div>

      <div className="max-w-55.5 p-6 flex justify-between gap-1 w-full rounded-lg border-l-4 border-l-[#BA1A1A] bg-white shadow-sm">
        <div>
          <p className="text-[#434655] text-xs font-bold leading-4 tracking-[0.6px] uppercase mb-1">
            Kritik
          </p>
      ...
      <div className="max-w-55.5 p-6 flex justify-between gap-1 w-full rounded-lg border-l-4 border-l-gray-700 bg-white shadow-sm">
        <div>
          <p className="text-[#434655] text-xs font-bold leading-4 tracking-[0.6px] uppercase mb-1">
            Offline
          </p>
